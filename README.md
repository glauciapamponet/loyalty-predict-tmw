...
Construindo uma solução de Data Science junto com a comunidade! Confira todo o material em [cursos.teomewhy.org](cursos.teomewhy.org).
...
Considerando a integração de usuários disposta nesses três sistemas, o plano atende à proposta de elevar a capacidade de escalabilidade e visibilidade da comunidade, mediante os dados de engajamento nesses portais de forma transacional. O objetivo engloba também identificar perda ou ganho de engajamento dos usuários da comunidade.
